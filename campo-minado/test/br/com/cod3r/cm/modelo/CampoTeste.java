...
public class CampoTeste {
	...
	@Test
	void testeValorPadrsoAtributoMarcado() {
	...
	@Test
	void testeToStringMinadoEAberto() {
		campo.abrir();
		campo.minar();
		System.out.println(campo.toString());
	}
	...
	@Test
	void testeLinha() {
		Campo campo = new Campo(9, 15);
		System.out.println(campo.getLinha());
	}

	@Test
	void testeColuna() {
		Campo campo = new Campo(9, 15);
		System.out.println(campo.getColuna());
	}
